...
func (_m *Client) Send(request []byte) ([]byte, error) {
...
//   - request []byte
func (_e *Client_Expecter) Send(request interface{}) *Client_Send_Call {
	return &Client_Send_Call{Call: _e.mock.On("Send", request)}
}

func (_c *Client_Send_Call) Run(run func(request []byte)) *Client_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte))
	})
	return _c
...
func (_c *Client_Send_Call) RunAndReturn(run func([]byte) ([]byte, error)) *Client_Send_Call {
	_c.Call.Return(run)
	return _c
}
